 ...
 <?php
  ...
  if (mysqli_num_rows($hasil) === 0) {
    echo '<div class="container py-5 text-center">
      ...
      <a href="menu.php" class="btn-pill mt-3">Kembali ke Resep</a>
    </div>';
    die;
  }
 ...
 <section class="container py-4">
   <a href="menu.php" class="text-decoration-none text-grey2 d-inline-flex align-items-center gap-2 mb-3">
   ...
   <div class="kotak shadow mt-4">
     ...
     <div class="d-flex flex-wrap gap-3 mt-3">
       <?php
        ...
        ?>
         <a href="detailBelumLogin.php?id_resep=<?= $resep['id_resep'] ?>" class="resep-lain">
